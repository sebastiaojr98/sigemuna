@section('funders') active @endsection
<div>
                ...
                <div class="card-body">
                    ...
                    <form class="row align-items-center mr-2" wire:submit="printRelatory()">
                        <div class="form-group col-3">
                            <label for="">Tipo de Financiador</label>
                            <select name="" id="" class="form-control" wire:model="financier">
                        ...
                        <table class="table table-striped table-sms">
                          <thead>
                            <tr class="btn-reveal-trigger">
                                <th scope="col"  style="font-size: 9pt;">Tipo de Financiador</th>
                                ...
                                <th scope="col"  style="font-size: 9pt;">E-mail</th>
                            </tr>
                          </thead>
                          <tbody>
                            @foreach($funders as $funder)
                            <tr class="btn-reveal-trigger">
                                <td style="font-size: 9pt;">{{$funder->typeFunder->label}}</td>
                                <td style="font-size: 9pt;">{{$funder->name}}</td>
                                <td style="font-size: 9pt;">{{$funder->country}}</td>
                                <td style="font-size: 9pt;">{{$funder->city}}</td>
                                <td style="font-size: 9pt;">{{$funder->address}}</td>
                                <td style="font-size: 9pt;">{{$funder->phone}}</td>
                                <td style="font-size: 9pt;">{{$funder->email}}</td>
                            </tr>
                            @endforeach
                          </tbody>
                        </table>
        ...
        {{--<div class="col-xxl-4">
          <div class="card">
            <div class="card-header d-flex flex-between-center py-2 border-bottom">
              <h6 class="mb-0">Analise grafica de Financiamentos</h6>
            </div>
          ...
          <div class="modal-content border-0">
            ...
            <div class="modal-body p-0">
              <div class="bg-light rounded-top-3 py-3 ps-4">
                <h4 class="mb-1" id="staticBackdropLabel"> <i class="fas fa-university text-primary"></i> FINANCIADOR</h4>
              </div>
              <div class="px-4 py-3">
                {{-- Dados do Modal --}}
                <livewire:formulario-financiador />
                {{-- Dados do Modal --}}
