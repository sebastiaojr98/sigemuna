@section('neighborhoods') active @endsection
<div>
                        ...
                        <table class="table table-striped table-sms">
                          <thead>
                            <tr class="btn-reveal-trigger">
                                ...
                                <th scope="col"  style="font-size: 11pt;">Posto Administrativo</th>
                            </tr>
                          </thead>
                          <tbody>
                            @foreach($neighborhoods as $neighborhood)
                            <tr class="btn-reveal-trigger">
                                <td style="font-size: 11pt;">{{$neighborhood->label}}</td>
                                <td style="font-size: 11pt;">{{$neighborhood->administrativePost->label}}</td>
                            </tr>
                            @endforeach
                          </tbody>
                        </table>
          ...
          <div class="modal-content border-0">
            ...
            <div class="modal-body p-0">
              <div class="bg-light rounded-top-3 py-3 ps-4">
                <h4 class="mb-1" id="staticBackdropLabel">BAIRRO</h4>
              </div>
              <div class="px-4 py-3">
                {{-- Dados do Modal --}}
                <livewire:formulario-bairro />
                {{-- Dados do Modal --}}
