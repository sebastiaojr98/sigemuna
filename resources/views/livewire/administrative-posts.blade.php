@section('administrativePosts') active @endsection
<div>
                    ...
                    <div>
                        <table class="table table-striped table-sms">
                          ...
                          <tbody>
                            ...
                            <tr class="btn-reveal-trigger">
                                <td style="font-size: 11pt;">{{$administrative_post->label}}</td>
                            </tr>
                            @endforeach
                          </tbody>
                        </table>
                         {{ $administrative_posts->links() }}                      
                      </div>
          ...
          <div class="modal-content border-0">
            ...
            <div class="modal-body p-0">
              <div class="bg-light rounded-top-3 py-3 ps-4">
                <h4 class="mb-1" id="staticBackdropLabel">POSTO ADMINISTRATIVO</h4>
              </div>
              <div class="px-4 py-3">
                {{-- Dados do Modal --}}
                <livewire:formulario-posto-administrativo />
                {{-- Dados do Modal --}}
