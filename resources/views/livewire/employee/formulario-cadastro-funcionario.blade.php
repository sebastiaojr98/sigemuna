<form class="row" wire:submit="createEmployee()">
    <div class="col-4 form-group">
        <label for="">Código (Número do processo)</label>
        <input type="text" class="form form-control" placeholder="número" wire:model="code">
    </div>
    <div class="col-4 form-group">
    ...
    <div class="col-4 form-group">
        ...
        <input type="text" class="form form-control" placeholder="nomes proprios" wire:model="first_name">
    ...
    <div class="col-6 form-group">
        <label for=""><span class="span-required">*</span>Nome do Pai (Filiação)</label>
        <input type="text" class="form form-control" placeholder="filiação" wire:model="father_name">
        @error('father_name') <small class="alert-error"> {{ $message }} </small> @enderror
    </div>
    <div class="col-6 form-group">
        <label for=""><span class="span-required">*</span>Nome da Mae (Filiação)</label>
        <input type="text" class="form form-control" placeholder="filiação" wire:model="name_mother">
