@section('invoices') active @endsection
        ...
        <div class="card">
            <div class="card-body">
                <div class="row justify-content-between align-items-center">
                    <div class="col-5">
                        <h1 class="h3 text-primary">Facturas</h1>
                    </div>
                    <div class="col-7"></div>
                </div>
                <hr>
                    ...
                    <table class="table table-striped table-sms">
                      <thead>
                        <tr class="btn-reveal-trigger">
                            ...
                            <th scope="col"  style="font-size: 11pt;" class="text-center">Tipo</th>
                            <th scope="col"  style="font-size: 11pt;">Serviço</th>
                            <th scope="col"  style="font-size: 11pt;" class="text-center">Montante (MT)</th>
                      ...
                      <tbody>
                        ...
                        <tr class="btn-reveal-trigger">
                            <td style="font-size: 10pt;">{{$invoice->number}}</td>
                            <td style="font-size: 10pt;">{{$invoice->customer->name}}</td>
                            <td style="font-size: 10pt;" class="text-center">{{$invoice->type}}</td>
                            <td style="font-size: 10pt;">{{$invoice->serviceContracted->service->name}}</td>
                            <td style="font-size: 10pt;" class="text-center">{{formatAmount($invoice->total_amount)}}</td>
