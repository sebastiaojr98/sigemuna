@section('communal-units') active @endsection
<div>
                        ...
                        <table class="table table-striped table-sms">
                          <thead>
                            <tr class="btn-reveal-trigger">
                                ...
                                <th scope="col"  style="font-size: 11pt;">Bairro</th>
                            </tr>
                          </thead>
                          <tbody>
                            @foreach($communal_units as $communal_unity)
                            <tr class="btn-reveal-trigger">
                                <td style="font-size: 11pt;">{{$communal_unity->label}}</td>
                                <td style="font-size: 11pt;">{{$communal_unity->neighborhood->label}}</td>
                            </tr>
                            @endforeach
                          </tbody>
                        </table>
                         {{ $communal_units->links() }}                      
                      </div>
          ...
          <div class="modal-content border-0">
            ...
            <div class="modal-body p-0">
              <div class="bg-light rounded-top-3 py-3 ps-4">
                <h4 class="mb-1" id="staticBackdropLabel">UNIDADE COMUNAL</h4>
              </div>
              <div class="px-4 py-3">
                {{-- Dados do Modal --}}
                <livewire:formulario-unidade-comunal />
                {{-- Dados do Modal --}}
