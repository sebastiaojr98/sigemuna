                ...
                <div class="col">
                  <div class="d-flex align-items-center">
                    ...
                    <div>
                      ...
                      <div class="fs--2 fw-semi-bold">Montante: {{number_format($expense_year, 2, ".", " ")}}MT</div>
                    </div>
                  </div>
                </div>
                ...
                <div class="col">
                  <div class="d-flex align-items-center">
                    ...
                    <div>
                      ...
                      <div class="fs--2 fw-semi-bold">Montante: {{number_format($expense_last_month, 2, ".", " ")}}MT</div>
                    </div>
                  </div>
                </div>
                <div class="col-auto text-center ps-2">
                  <div class="fs-1 fw-normal font-sans-serif text-warning mb-1 lh-1">
                    @if ($expense_year > 0)
                    {{number_format($expense_last_month * 100 / $expense_year, 2)}}%
                    @else
                    0%
                    @endif
                  </div>
              ...
              <div class="row g-0 h-100 align-items-center">
                <div class="col">
                  <div class="d-flex align-items-center">
                    ...
                    <div>
                      <h6 class="mb-2">Relatorio Mensal</h6>
                      <div class="fs--2 fw-semi-bold">Montante: {{number_format($expense_current_month, 2, ".", " ")}}MT</div>
                    </div>
                  </div>
                </div>
                <div class="col-auto text-center ps-2">
                  <div class="fs-1 fw-normal font-sans-serif text-success mb-1 lh-1">
                    @if ($expense_year > 0)
                    {{number_format($expense_current_month * 100 / $expense_year, 2)}}%
                    @else
                    0%
                    @endif
                  </div>
