@section('financings') active @endsection
<div>
                ...
                <div class="card-body">
                    ...
                    <form class="row align-items-center mr-2" wire:submit="printRelatoty()">
                        <div class="form-group col-3">
                            <label for="">Financiador</label>
                            <select class="form-control" wire:model="financiador" required>
                    ...
                    <hr>
                    <livewire:financing-card-relatory />
                    <hr>
                    <div>
                        <table class="table table-striped">
                          <thead>
                            <tr class="btn-reveal-trigger">
                                ...
                                <th scope="col"  style="font-size: 11pt;">Financiador</th>
                                ...
                                <th scope="col"  style="font-size: 11pt;"  class="text-center">Taxa de Juro</th>
                          ...
                          <tbody>
                            ...
                            <tr class="btn-reveal-trigger">
                                <td style="font-size: 10pt;">{{$financing->process_number}}</td>
                                <td style="font-size: 10pt;">{{$financing->financier->name}}</td>
                                <td style="font-size: 10pt;" class="text-end">{{number_format($financing->amount, 2, ".", " ")}} MT</td>
                                <td style="font-size: 10pt;"  class="text-center">{{$financing->start_date}}</td>
                                <td style="font-size: 10pt;"  class="text-center">{{$financing->end_date}}</td>
                                <td style="font-size: 10pt;"  class="text-center">{{$financing->interest_rate}} %</td>
                                @if ($financing->status == "0")
                                    <td style="font-size: 10pt;" class="text-danger text-center"><span class="badge bg-danger">Cancelado</span></td>
                                  @elseif($financing->status == "1")
                                    <td style="font-size: 10pt;" class="text-primary text-center"><span class="badge bg-primary">Ativo</span></td>
                                  @elseif($financing->status == "2")
                                    <td style="font-size: 10pt;" class="text-success text-center"><span class="badge bg-success">Concluido</span></td>
                                  @endif
                                <td class="text-center">
                                  <a target="_blank" href="{{asset("/storage/".$financing->document)}}" class="text-danger"> <i class="fas fa-file-pdf" style="font-size: 15pt;"></i> </a>
                                </td>
                            </tr>
                            @endforeach
                          </tbody>
          ...
          <div class="modal-content border-0">
            ...
            <div class="modal-body p-0">
              <div class="bg-light rounded-top-3 py-3 ps-4">
                <h4 class="mb-1" id="staticBackdropLabel"> <i class="fas fa-coins text-success"></i> FINANCIADOR</h4>
              </div>
              <div class="px-4 py-3">
                {{-- Dados do Modal --}}
                <livewire:formulario-financiamento />
                {{-- Dados do Modal --}}
