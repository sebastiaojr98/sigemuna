        ...
        <div class="tm_invoice_in">
          <div class="tm_invoice_head tm_top_head tm_mb15 tm_align_center">
            ...
            <div class="tm_invoice_right tm_text_right tm_mobile_hide">
              <div class="tm_f50 tm_text_uppercase tm_white_color">Recibo</div>
            </div>
          ...
          <div class="tm_invoice_info tm_mb25">
            ...
            <div class="tm_invoice_info_list tm_white_color">
              <p class="tm_invoice_number tm_m0">Recibo Nº: <b>#{{$revenue->reference}}</b></p>
          ...
          <div class="tm_invoice_head tm_mb10">
            ...
            <div class="tm_invoice_right tm_text_right">
              <p class="tm_mb2"><b class="tm_primary_color">De</b></p>
              <p>
          ...
          <div class="tm_table tm_style1">
                ...
                <table>
                  <thead>
                    <tr class="tm_accent_bg">
                      <th class="tm_width_3 tm_semi_bold tm_white_color">Descrição</th>
                      <th class="tm_width_4 tm_semi_bold tm_white_color">Referência</th>
                      <th class="tm_width_3 tm_semi_bold tm_white_color tm_text_right">Valor Pago</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
                      ...
                      <td class="tm_width_3 tm_text_right">{{formatAmount($revenue->amount)}}</td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <div class="tm_invoice_footer tm_border_top tm_mb5 tm_m0_md">
              <div class="tm_left_footer">
                <p class="tm_mb2"><b class="tm_primary_color">Método de Pagamento</b></p>
                <ul style="margin-left: 15px;">
                  <li>Forma de Pagamento: {{$revenue->form_payment->label}}</li>
                  <li>Data do Pagamento: {{date("d-m-Y", strtotime($revenue->revenue_date))}}</li>
                  <li>Referência: {{$revenue->reference}}</li>
                </ul>
              </div>
              <div class="tm_right_footer">
                <table class="tm_mb15">
                  <tbody>
                    <tr class="tm_accent_bg">
                      <td class="tm_width_3 tm_border_top_0 tm_bold tm_f16 tm_white_color">Total Pago</td>
            ...
            <div class="tm_invoice_footer tm_type1">
              <div class="tm_left_footer" style="text-align: center;">
                <img style="width: 100px;" src="{{--asset('qrcodes_receipt/1fd7772b351fdecb876ba92a109abf65131123113016.jpg')--}}" alt="Código de Verificação">
              </div>
              <div class="tm_right_footer">
                <div class="tm_sign tm_text_center" style="padding-top: 40px;">
                  ...
                  <small><em>Recebido por SIGEMUNA: {{date('d-m-Y H:i:s')}}</em></small>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="tm_note tm_text_center tm_font_style_normal">
            <hr class="tm_mb15">
            <p class="tm_mb2"><b class="tm_primary_color">Declaração de Confirmação</b></p>
            <p class="tm_m0">Este documento comprova o pagamento integral do valor mencionado. Em caso de divergências, favor contactar nossa equipe dentro de 5 dias úteis.</p>
          </div>
        </div>
      </div>
    </div>
